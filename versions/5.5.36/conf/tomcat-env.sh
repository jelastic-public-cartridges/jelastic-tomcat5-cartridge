...
APP_ENV="/opt/repo/versions/5.5.36/conf/tomcat-env.sh"
JAVA_HOME="/usr/java/latest"
CATALINA_HOME="/opt/repo/versions/5.5.36"
JASPER_HOME="/opt/repo/versions/5.5.36"
CATALINA_TMPDIR="/opt/repo/versions/5.5.36/temp"
CATALINA_BASE="/opt/repo/versions/5.5.36"
JVM_ID="tomcat"
VTUNIP=""
MAGICPORT=""
